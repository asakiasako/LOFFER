...
这一章将会解释复杂编码是如何减少所需的光带宽的。我们还会介绍几种调制方案，并指导如何为特定的速率等级和传输距离选择最合适的方案。
...
Figure 10 以 QPSK 为例展示了这个公式。如果信号还使用了偏振复用，我们可以将符号速率再除以 2。对于 100-Gbps 的 QPSK 信号来说，这意味着符号速率 S = (100 Gbps)/ (2 bits/symbol)/ (2 polarizations) = 25 Gbaud。最小需要占据的光带宽变成了 25 GHz。
